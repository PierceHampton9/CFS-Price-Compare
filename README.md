...
Current status: Windows spec detection, initial query building, eBay active-listing search, basic listing condition normalization, and standalone price aggregation work.
